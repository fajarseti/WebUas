...
<form action='save_pasien.php' method='post'>
	<fieldset>
	<legend align='center'>Form Pendaftaran Member</legend>
	<table col=3 row=8>
		<tr>
		<td>Kode Pelanggan</td>
		<td> : </td>
		<td><input type='text' name='nirm' value='IR001' disabled></td>
		</tr>	
		<tr>
		<td>Nama</td>
		<td> : </td>
		...
		<td> : </td>
		<td><input type='text' name='nama_pasien' value='999999999'></td>
		</tr>
		<tr>
		<td>Alamat</td>
		<td> : </td>
